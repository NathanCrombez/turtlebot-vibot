...
class MoveItDemo:
    def __init__(self):
        ...
        table_size = [0.7, 0.7, 0.01]#set the table coordinates in order to contain the whole scene [first value  = 0.2 before]
        #box1_size = [0.1, 0.05, 0.05]
        #box2_size = [0.05, 0.05, 0.15]

        # Set the target size [l, w, h]
        target_size = [0.018, 0.018, 0.018]#corresponds roughly to the size of the cube
